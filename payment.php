    ...
    <div class="payment-form">
        ...
        <?php else: ?>
            ...
            <form method="post" autocomplete="off">
                ...
                <div class="order-summary" style="background:#f7f7f7; border-radius:6px; padding:1.2em; margin-bottom:1.5em;">
                    ...
                    <ul style="list-style:none; padding:0; margin:0;">
                        <?php $total = 0; foreach ($_SESSION['cart'] as $productId => $qty):
                            ...
                            $total += $subtotal;
                        ?>
                        <li style="display:flex; align-items:center; gap:1em; margin-bottom:0.7em;">
                            <?php if (!empty($product['image'])): ?>
                                <img src="<?php echo htmlspecialchars($product['image']); ?>" alt="<?php echo htmlspecialchars($product['name']); ?>" style="width:48px; height:48px; object-fit:contain; background:transparent;">
                            <?php endif; ?>
                    ...
                    <div class="total" style="text-align:right; font-weight:bold; font-size:1.1em; margin-top:1em;">Total: ₱<?php echo number_format($total,2); ?></div>
                </div>
